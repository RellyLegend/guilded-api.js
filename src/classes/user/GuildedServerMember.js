const { GuildedUser } = require('./GuildedUser');

class GuildedServerMember {
    constructor(memberData) {
        ...
        if (memberData.member) {
            if (memberData.member.user) {
                this.user = new GuildedUser(memberData.member.user);
            }
        } else {
            this.user = null;
        }
...
module.exports.GuildedServerMember = GuildedServerMember;